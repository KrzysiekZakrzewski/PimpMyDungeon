...
namespace Animation.DoTween
{
    public class LevelLoadAnimation : MonoBehaviour
    {
        ...
        [Inject]
        private void Inject(LevelSelectorView levelSelectorView)
        {
        ...
        private Sequence StartSingleSequence(RectTransform item)
        {
            ...
            sequence.Append(item.DOAnchorPosY(-Screen.height - Screen.height * 2, moveDuration));
        ...
        private Sequence SequnceTitle()
        {
            ...
            sequence.Append(title.DOAnchorPosY(-Screen.height - Screen.height * 2, moveDuration));
        ...
        public void PlayAnimation(Action endAction)
        {
            ...
            levelSelectorView.OffInteractable();
